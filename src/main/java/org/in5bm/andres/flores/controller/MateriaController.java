package org.in5bm.andres.flores.controller;
...
import org.in5bm.andres.flores.db.Conexion;
import org.in5bm.andres.flores.models.domain.Materia;
import org.in5bm.andres.flores.system.Principal;
...
public class MateriaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        valueFactoryCupoMaximo = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 250, 100);
        spnCupoMaximo.setValueFactory(valueFactoryCupoMaximo);

        valueFactoryCupoMinimo = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 99, 1);
        spnCupoMinimo.setValueFactory(valueFactoryCupoMinimo);

        valueFactoryNota = new SpinnerValueFactory.IntegerSpinnerValueFactory(50, 100, 70);
        ...
        switch (operacion) {
            ...
            case GUARDAR:
                ...
                if (txtMateria.getText().isEmpty()) {
                    ...
                    alert.setContentText("Complete el campo materia");
                    ...
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setHeaderText(null);
                    alert.setContentText("}Complete el campo catedratico");
                    Stage dialog = new Stage();
                    Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
                    alert.show();
